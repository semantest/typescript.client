...
export class EventDrivenWebBuddyClient {
    ...
    // === Google Images download methods have been moved to images.google.com module ===
    ...
    // === Google Images batch download methods have been moved to images.google.com module ===
    ...
    private extractEventPayload(event: DomainEvent): any {
        ...
        // Google Images event payload extraction moved to images.google.com module
